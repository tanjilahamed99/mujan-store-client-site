        ...
        <div className="mb-10">
            ...
            <div className="container lg:mx-auto mx-5">
                ...
                <div className="flex flex-col lg:flex-row lg:justify-between mt-4">
                    <h2 className="text-3xl font-semibold lg:w-[40%]">
                ...
                <div className="my-10 flex flex-col lg:flex-row gap-20">
                    <img className="lg:w-1/2 h-[400px]" src="https://i.ibb.co/WnHBQrp/mujan.jpg" alt="" />
                    ...
                    <div className="hero-content  text-neutral-content">
                        <div className="flex flex-col lg:flex-row items-center justify-between gap -20">
                            <div className="lg:w-1/2">
                                ...
                                <p className="xl:text-6xl text-3xl font-bold pr-20 mt-5">Technology is only as good as the people behind it</p>
                            </div>
                            <div className="lg:w-1/2">
